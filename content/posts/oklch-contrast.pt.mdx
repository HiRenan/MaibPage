...
texto/fundo passa de 4.5:1. Então não se opina sobre contraste. Calcula-se. O repo
...
O caso concreto foi o `destructive`, o vermelho de erro (MAI-661). Eu tinha posto o L
...
> Cor bonita é opinião. Contraste é número. Uma você discute, o outro você mede.
